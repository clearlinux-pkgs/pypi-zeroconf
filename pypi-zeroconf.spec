...
Source0  : https://files.pythonhosted.org/packages/a9/af/d5a16dc6081dc41507b65ed0d499e3c71728a3fbec4c14df6b2ec8eae1a7/zeroconf-0.38.4.tar.gz
...
%prep
%setup -q -n zeroconf-0.38.4
cd %{_builddir}/zeroconf-0.38.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646098890
...
cp %{_builddir}/zeroconf-0.38.4/COPYING %{buildroot}/usr/share/package-licenses/pypi-zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
