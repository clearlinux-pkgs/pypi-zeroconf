...
Source0  : https://files.pythonhosted.org/packages/ef/e4/a43283a5dc0ad6dd1f1094a02ad40cb17623b589b86991fd997e5627efe9/zeroconf-0.39.1.tar.gz
...
%prep
%setup -q -n zeroconf-0.39.1
cd %{_builddir}/zeroconf-0.39.1
pushd ..
cp -a zeroconf-0.39.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662481267
