...
Source0  : https://files.pythonhosted.org/packages/24/7d/02e8c583b57692eee495e60c7a4dd862635a9702067d69c6dd1c907cb589/zeroconf-0.132.2.tar.gz
...
%prep
%setup -q -n zeroconf-0.132.2
cd %{_builddir}/zeroconf-0.132.2
pushd ..
cp -a zeroconf-0.132.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713039175
