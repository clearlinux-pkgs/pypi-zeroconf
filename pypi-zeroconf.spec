...
Source0  : https://files.pythonhosted.org/packages/89/e0/cddc7e2272799e11ea172810fd2f6da58fc7290f9bd3102d6cf2c385cca3/zeroconf-0.136.2.tar.gz
...
%prep
%setup -q -n zeroconf-0.136.2
cd %{_builddir}/zeroconf-0.136.2
pushd ..
cp -a zeroconf-0.136.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732290683
