...
%prep
%setup -q -n zeroconf-0.38.1
cd %{_builddir}/zeroconf-0.38.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641602327
...
cp %{_builddir}/zeroconf-0.38.1/COPYING %{buildroot}/usr/share/package-licenses/pypi-zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
