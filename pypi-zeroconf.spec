...
Source0  : https://files.pythonhosted.org/packages/5d/3f/25d4da0ada92e618a903d0a5d5e096d84b78050c5cb90ad8691a53e8692b/zeroconf-0.38.7.tar.gz
...
%prep
%setup -q -n zeroconf-0.38.7
cd %{_builddir}/zeroconf-0.38.7
pushd ..
cp -a zeroconf-0.38.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655256290
...
cp %{_builddir}/zeroconf-0.38.7/COPYING %{buildroot}/usr/share/package-licenses/pypi-zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
