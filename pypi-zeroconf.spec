...
Source0  : https://files.pythonhosted.org/packages/f5/4f/c47cea73d7ae5467b63de3999d7207fd5b14d70cb2f35ce81c4ab7d7a52e/zeroconf-0.39.4.tar.gz
...
%prep
%setup -q -n zeroconf-0.39.4
cd %{_builddir}/zeroconf-0.39.4
pushd ..
cp -a zeroconf-0.39.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667332372
