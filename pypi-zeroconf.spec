...
Source0  : https://files.pythonhosted.org/packages/43/6b/5fa7a4c677376b549655d67f6902c80bde4b534405cdf2b5f0c50cc7bd8a/zeroconf-0.146.1.tar.gz
...
%prep
%setup -q -n zeroconf-0.146.1
cd %{_builddir}/zeroconf-0.146.1
pushd ..
cp -a zeroconf-0.146.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741294083
