...
Source0  : https://files.pythonhosted.org/packages/b0/32/242620030c197fdc984f23e956518754d062a0625154514d663685106f3c/zeroconf-0.38.6.tar.gz
...
%prep
%setup -q -n zeroconf-0.38.6
cd %{_builddir}/zeroconf-0.38.6
pushd ..
cp -a zeroconf-0.38.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653004184
...
cp %{_builddir}/zeroconf-0.38.6/COPYING %{buildroot}/usr/share/package-licenses/pypi-zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
