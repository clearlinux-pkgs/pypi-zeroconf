...
Source0  : https://files.pythonhosted.org/packages/e2/78/f681afade2a4e7a9ade696cf3d3dcd9905e28720d74c16cafb83b5dd5c0a/zeroconf-0.147.0.tar.gz
...
%prep
%setup -q -n zeroconf-0.147.0
cd %{_builddir}/zeroconf-0.147.0
pushd ..
cp -a zeroconf-0.147.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746461839
