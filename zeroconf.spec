...
Source0  : https://files.pythonhosted.org/packages/ca/77/eb6137997adc60811c6c46b28b00abac5c16daf14383f61d8a0180326b38/zeroconf-0.29.0.tar.gz
...
%prep
%setup -q -n zeroconf-0.29.0
cd %{_builddir}/zeroconf-0.29.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616693463
...
cp %{_builddir}/zeroconf-0.29.0/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
