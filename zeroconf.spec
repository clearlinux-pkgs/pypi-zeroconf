...
Version  : 0.28.3
Release  : 31
URL      : https://files.pythonhosted.org/packages/c2/34/29c9312ecb70e9dad749f170bc2b60a43777bf80b54f796d2460a1178460/zeroconf-0.28.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/c2/34/29c9312ecb70e9dad749f170bc2b60a43777bf80b54f796d2460a1178460/zeroconf-0.28.3.tar.gz
...
%prep
%setup -q -n zeroconf-0.28.3
cd %{_builddir}/zeroconf-0.28.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598907823
...
cp %{_builddir}/zeroconf-0.28.3/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
