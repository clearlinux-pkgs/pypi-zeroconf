...
Source0  : https://files.pythonhosted.org/packages/8c/5f/627662968753c3e03475d2b62a223c90f6ce98eb6e6d2d03ed03b560292e/zeroconf-0.28.0.tar.gz
...
%prep
%setup -q -n zeroconf-0.28.0
cd %{_builddir}/zeroconf-0.28.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594143181
...
cp %{_builddir}/zeroconf-0.28.0/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
