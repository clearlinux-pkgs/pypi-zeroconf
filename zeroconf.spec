...
Source0  : https://files.pythonhosted.org/packages/cc/66/4b509ea71cf2daf2e590eb1194753b26ee0a593ecbab85dcf1838bac3073/zeroconf-0.36.12.tar.gz
...
%prep
%setup -q -n zeroconf-0.36.12
cd %{_builddir}/zeroconf-0.36.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636149491
...
cp %{_builddir}/zeroconf-0.36.12/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
