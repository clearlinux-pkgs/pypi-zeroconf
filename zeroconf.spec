...
Source0  : https://files.pythonhosted.org/packages/93/22/e6e46427412134baaabc8e8232861da1acf8a2e8067b46f3f9149b0805cb/zeroconf-0.24.5.tar.gz
...
%prep
%setup -q -n zeroconf-0.24.5
cd %{_builddir}/zeroconf-0.24.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583774599
...
cp %{_builddir}/zeroconf-0.24.5/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
