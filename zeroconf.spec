...
Version  : 0.36.1
Release  : 57
URL      : https://files.pythonhosted.org/packages/62/e0/4fc789385766049903e4d22e051a94081549d32d719077f65d57eec0263b/zeroconf-0.36.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/62/e0/4fc789385766049903e4d22e051a94081549d32d719077f65d57eec0263b/zeroconf-0.36.1.tar.gz
...
%prep
%setup -q -n zeroconf-0.36.1
cd %{_builddir}/zeroconf-0.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630340439
...
cp %{_builddir}/zeroconf-0.36.1/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
