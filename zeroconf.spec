...
Source0  : https://files.pythonhosted.org/packages/b4/a5/ff02c5af3728816acca71d052cb77c5379b5bc39a20fc1f4994b9d35cfca/zeroconf-0.31.0.tar.gz
...
%prep
%setup -q -n zeroconf-0.31.0
cd %{_builddir}/zeroconf-0.31.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621300168
...
cp %{_builddir}/zeroconf-0.31.0/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
