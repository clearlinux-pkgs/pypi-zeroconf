...
Source0  : https://files.pythonhosted.org/packages/9b/6e/4ee8219d80b62b24728860434ad30e467a4a957fae2b4386da47f69168ed/zeroconf-0.27.1.tar.gz
...
%prep
%setup -q -n zeroconf-0.27.1
cd %{_builddir}/zeroconf-0.27.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591377301
...
cp %{_builddir}/zeroconf-0.27.1/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
