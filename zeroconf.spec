...
Source0  : https://files.pythonhosted.org/packages/a0/ed/611f51aae5be86f1b2e608998020eec31a6393f351d6ad865e6b3729ac65/zeroconf-0.36.8.tar.gz
...
%prep
%setup -q -n zeroconf-0.36.8
cd %{_builddir}/zeroconf-0.36.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633966627
...
cp %{_builddir}/zeroconf-0.36.8/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
