...
Source0  : https://files.pythonhosted.org/packages/74/9d/e3f93bb9dd957405e62df884f5c242e70e239b3b669bf02dd16b4b214e28/zeroconf-0.36.2.tar.gz
...
%prep
%setup -q -n zeroconf-0.36.2
cd %{_builddir}/zeroconf-0.36.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630341505
...
cp %{_builddir}/zeroconf-0.36.2/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
