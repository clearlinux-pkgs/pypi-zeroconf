...
%prep
%setup -q -n zeroconf-0.26.0
cd %{_builddir}/zeroconf-0.26.0
...
cp %{_builddir}/zeroconf-0.26.0/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
