...
Version  : 0.25.1
Release  : 20
URL      : https://files.pythonhosted.org/packages/1b/d8/9a5d74c972aa29b5d1dc98080aecaaad2a82760b01eeacffa4b268437e82/zeroconf-0.25.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/1b/d8/9a5d74c972aa29b5d1dc98080aecaaad2a82760b01eeacffa4b268437e82/zeroconf-0.25.1.tar.gz
...
%prep
%setup -q -n zeroconf-0.25.1
cd %{_builddir}/zeroconf-0.25.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587000620
...
cp %{_builddir}/zeroconf-0.25.1/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
