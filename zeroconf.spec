...
Version  : 0.26.1
Release  : 23
URL      : https://files.pythonhosted.org/packages/ae/e3/20cf4994dc4be49bc48f6e49db2d8bd94579bd897982b19bfc9ae54dfeec/zeroconf-0.26.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/ae/e3/20cf4994dc4be49bc48f6e49db2d8bd94579bd897982b19bfc9ae54dfeec/zeroconf-0.26.1.tar.gz
...
%prep
%setup -q -n zeroconf-0.26.1
cd %{_builddir}/zeroconf-0.26.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588788432
...
cp %{_builddir}/zeroconf-0.26.1/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
