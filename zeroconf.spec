...
Version  : 0.24.1
Release  : 12
URL      : https://files.pythonhosted.org/packages/a3/9a/0f2bf49cdc1523c835d2942774d2fe4feb713fac71d618b35a9fb7fe35e3/zeroconf-0.24.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/a3/9a/0f2bf49cdc1523c835d2942774d2fe4feb713fac71d618b35a9fb7fe35e3/zeroconf-0.24.1.tar.gz
...
%prep
%setup -q -n zeroconf-0.24.1
cd %{_builddir}/zeroconf-0.24.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576540162
...
cp %{_builddir}/zeroconf-0.24.1/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
