...
Source0  : https://files.pythonhosted.org/packages/11/c9/903f1df6e9e9a3cff4f7123891f4855ce94de167cddef87a6e85da71f72b/zeroconf-0.25.0.tar.gz
...
%prep
%setup -q -n zeroconf-0.25.0
cd %{_builddir}/zeroconf-0.25.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585961495
...
cp %{_builddir}/zeroconf-0.25.0/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
