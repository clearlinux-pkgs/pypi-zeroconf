...
Version  : 0.36.6
Release  : 61
URL      : https://files.pythonhosted.org/packages/be/f9/529658db74dd673943c86160545cac1878ff2280407614861a1b3f31a506/zeroconf-0.36.6.tar.gz
Source0  : https://files.pythonhosted.org/packages/be/f9/529658db74dd673943c86160545cac1878ff2280407614861a1b3f31a506/zeroconf-0.36.6.tar.gz
...
%prep
%setup -q -n zeroconf-0.36.6
cd %{_builddir}/zeroconf-0.36.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632186651
...
cp %{_builddir}/zeroconf-0.36.6/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
