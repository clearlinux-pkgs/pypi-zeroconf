...
Source0  : https://files.pythonhosted.org/packages/1b/d1/3af9bc404c771375efb4b1e2e8c83f8fce9647b4fe018f92f5d8f2eb85f3/zeroconf-0.27.0.tar.gz
...
%prep
%setup -q -n zeroconf-0.27.0
cd %{_builddir}/zeroconf-0.27.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590682501
...
cp %{_builddir}/zeroconf-0.27.0/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
