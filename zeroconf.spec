...
Version  : 0.34.3
Release  : 54
URL      : https://files.pythonhosted.org/packages/81/e9/bbe4a07e2f8c0451ce597279599cee9948bd000f0adb43cc0469b402aebe/zeroconf-0.34.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/81/e9/bbe4a07e2f8c0451ce597279599cee9948bd000f0adb43cc0469b402aebe/zeroconf-0.34.3.tar.gz
...
%prep
%setup -q -n zeroconf-0.34.3
cd %{_builddir}/zeroconf-0.34.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628535634
...
cp %{_builddir}/zeroconf-0.34.3/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
