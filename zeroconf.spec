...
Version  : 0.33.3
Release  : 53
URL      : https://files.pythonhosted.org/packages/98/a3/65e95ec9165cd208286b8dc826c4e47dd13fe13c83358019ebe205455ed2/zeroconf-0.33.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/98/a3/65e95ec9165cd208286b8dc826c4e47dd13fe13c83358019ebe205455ed2/zeroconf-0.33.3.tar.gz
...
%prep
%setup -q -n zeroconf-0.33.3
cd %{_builddir}/zeroconf-0.33.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628216083
...
cp %{_builddir}/zeroconf-0.33.3/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/ab7752f30a9ae392de622ae6220b1034bbb4767a
