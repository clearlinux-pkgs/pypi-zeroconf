...
%prep
%setup -q -n zeroconf-0.28.8
cd %{_builddir}/zeroconf-0.28.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609799581
...
cp %{_builddir}/zeroconf-0.28.8/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
