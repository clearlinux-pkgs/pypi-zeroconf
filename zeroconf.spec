...
Source0  : https://files.pythonhosted.org/packages/35/1a/63df0e17b10f55d5e352048705ba6d4a2a8afb622914441b98b6f966743f/zeroconf-0.24.0.tar.gz
...
%prep
%setup -q -n zeroconf-0.24.0
cd %{_builddir}/zeroconf-0.24.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574405968
...
cp %{_builddir}/zeroconf-0.24.0/COPYING %{buildroot}/usr/share/package-licenses/zeroconf/720ac006232639ed551ce48d638dee35f8d378d4
